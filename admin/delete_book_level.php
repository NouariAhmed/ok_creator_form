...
?>
    ...
    <h4 class="mb-3">حذف مستوى كتاب</h4>
      <?php
        ...
        exit;
            ...
            if (mysqli_stmt_num_rows($stmt) === 0 && mysqli_stmt_num_rows($stmt2) === 0) {
                if (isset($_POST['confirm'])) {
                    ...
                    echo '
                    <p class="text-right">هل أنت متأكد أنك تريد حذف المستوى  ' . htmlspecialchars($levelData['level_name']) .' ؟</p>
                ...
                echo '<div class="alert alert-warning text-right">لا يمكن حذف هذا المستوى لأنه مستخدم من قبل مؤلفين أو مواد .</div>';
