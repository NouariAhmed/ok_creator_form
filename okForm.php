...
$uname = $email = $year_of_birth = $phone = $address = "";
$uname_err = $email_err = $year_of_birth_err = $phone_err = $address_err = $register_err = "";
include('connect.php');
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (empty($year_of_birth)) {
    $year_of_birth_err = "Please enter your year of birth.";
  ...
  if (empty($uname_err) && empty($email_err) && empty($year_of_birth_err) && empty($phone_err) && empty($address_err)) {
    // Create a database connection
    include('connect.php');

    // Insert the new user record into the database
    $sql_insert_user = "INSERT INTO users (username, email, year_of_birth, phone, address) VALUES (?, ?, ?, ?, ?)";
    $stmt_insert_user = mysqli_prepare($conn, $sql_insert_user);
    mysqli_stmt_bind_param($stmt_insert_user, "sssss", $uname, $email, $year_of_birth, $phone, $address);
