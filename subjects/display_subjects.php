    ...
    <div class="container">
        ...
        <form action="create_update_subject.php" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" name="subject_name" class="form-control" value="<?php echo htmlspecialchars(isset($item['subject_name']) ? $item['subject_name'] : ''); ?>" required>
            </div>
            <div class="form-group">
        ...
        <table class="table mt-3">
            ...
            <tbody>
                ...
                $result = mysqli_query($conn, "SELECT s.id, s.subject_name, bl.level_name FROM subjects s INNER JOIN book_levels bl ON s.book_level_id = bl.id");
